...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'wp_starter_theme' ); ?></h1>
	</header><!-- .page-header -->
		...
		if ( is_home() && current_user_can( 'publish_posts' ) ) :
			...
			printf(
				'<p>' . wp_kses(
					...
					__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'wp_starter_theme' ),
					array(
						'a' => array(
							'href' => array(),
						),
